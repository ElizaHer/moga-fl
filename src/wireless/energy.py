...
class EnergyEstimator:
    def __init__(self, cfg: Dict[str, Any]):
        self.tx_power = cfg.get('tx_power_watts', 1.0)
        self.compute_power = cfg.get('compute_power_watts', 10.0)
        self.compute_rate = cfg.get('compute_rate_samples_per_sec', 2000)
